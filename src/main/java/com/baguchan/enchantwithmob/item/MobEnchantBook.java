    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        if (MobEnchantUtils.hasMobEnchant(stack)) {
            ...
            if (mobEnchant != null) {
                ...
                tooltip.add(new TranslationTextComponent("mobenchant.enchantwithmob.name." + mobEnchant.getRegistryName().getNamespace() + "." + mobEnchant.getRegistryName().getPath()).applyTextStyles(textformatting));
            }
        }
    }
